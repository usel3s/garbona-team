...
| Бот команды | ваш рабочий Telegram-бот **Garbona** |

{% embed url="https://t.me/garbona" %}
...
{% hint style="warning" %}
Инвайт-ссылки на закрытые чаты выдаёт бот **персонально**. Не публикуйте их в открытых источниках и сторонних чатах.
{% endhint %}
