...
function buildChangelogPlainText() {
  return [
    ...
    "- О проекте: мануалы / чаты / инфоканал",
    "- Postbot: создание и отправка постов",
    "- Рассылка участникам команды",
    "- Тред мануалов (создание + закреп)",
    ...
    "- Коммуникация: рассылка, мануалы, анонс, changelog",
    "- Заявки, выплаты, экономика, Steam-логи, логи бота",
    "- Раздел Сайты для админа",
    "",
    "Worker panel (/app):",
    "- Панель воркера: логи, сайты, задачи, команда, настройки",
    "",
    "Stability:",
